            ...
            class NestedCarousel extends elementorModules.frontend.handlers.CarouselBase {
                ...
                wrapSlideContent() {
                    ...
                    this.findElement(`${e.selectors.slidesWrapper} > .e-con`).each((function() {
                        const i = jQuery(this),
                            r = i.closest("div").hasClass(t),
                            o = n.find(`${e.selectors.slidesWrapper} > .${t}:nth-child(${s})`);
                        r || o.append(i), s++
                    }))
                }
                ...
                linkContainer(e) {
                    ...
                    if (t.model.get("id") === this.$element.data("id")) {
                        ...
                        switch (i) {
                            case "move":
                                [t, o] = this.move(r, n, s, e);
                                break;
                            case "duplicate":
                                [t, o] = this.duplicate(r, n, s, e)
                        }
                        void 0 !== t && t.appendChild(o), this.updateIndexValues(e), this.updateListeners()
                    }
                }
                move(e, t, n, s) {
                    return [s[t], n.view.$el[0]]
                }
                duplicate(e, t, n, s) {
                    return [s[t + 1], n.view.$el[0]]
                }
                updateIndexValues(e) {
                    e.each(((e, t) => {
                        const n = e + 1;
                        t.setAttribute("data-slide", n)
                    }))
                }
                updateListeners() {
                    this.swiper.initialized = !1, this.swiper.init()
                }
                bindEvents() {
                    super.bindEvents(), elementorFrontend.elements.$window.on("elementor/nested-container/atomic-repeater", this.linkContainer.bind(this))
                }
            }
